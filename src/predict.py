...
# Load datasets
sym_des = load_csv("archive/symtoms_df.csv")
precautions = load_csv("archive/precautions_df.csv")
workout = load_csv("archive/workout_df.csv")
description = load_csv("archive/description.csv")
medications = load_csv('archive/medications.csv')
diets = load_csv("archive/diets.csv")
